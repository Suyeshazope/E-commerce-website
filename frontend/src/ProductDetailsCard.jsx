            ...
            <div className='w-[90%] 800px:w-[60%] h-[90vh] overflow-y-scroll 800px:h-[75vh] bg-white rounded-md relative p-4'>
              ...
              <div className='block w-full 800px:flex'>
                <div className='w-full 800px:w-[50%]'>
                  ...
                  <div className={`${styles.button} bg-[#231353] mt-4 rounded-[4px] h-11`} onClick={handleMessageSubmit}>
                ...
                <div className='w-full 800px:w-[50%] pt-5 pl-[5px] pr-[5px]'>
                  ...
                  <div className='flex items-center mt-12 justify-between pr-3'>
                      <div>
                        ...
                        <span className='bg-grat-200 text-gray-800 font-medium px-4 py-[11px]'>
                          {count}
                        </span>
                ...
                <div className={`${styles.button} bg-[#202433] mt-6 rounded h-11 flex items-center`}>
