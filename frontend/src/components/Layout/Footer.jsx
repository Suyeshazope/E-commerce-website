...
function Footer() {
    return (
        <div className='bg-[#000] text-white'>
            <div className='md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#19074e] py-7'>
                <h1 className='lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold md:w-2/5'>
                    <span className='text-[#4fdf5b]'>
                        Subscribe
                ...
                <div>
                    ...
                    <button className='bg-[#4fdf5b] hover:bg-green-500 duration-300 px-5 py-2.5 rounded-md text-white font-bold md:w-auto w-full'>
                        Submit
                    </button>
                </div>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center'>
                ...
                <ul className='text-center sm:text-start mt-2'>
                    <h1 className='mb-2 font-semibold'>
                        Company
                    </h1>
                    {footerProductLinks.map((link) => (
                        <li key={link.name}>
                            <Link className='text-gray-400 hover:text-green-500 duration-300 text-sm cursor-pointer leading-6' to={link.link}>
                                {link.name}
                            </Link>
                        </li>
                    ))
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 text-sm pb-8'>
                <span>© 2023 E-mart. All rights reserved.</span>
