    ...
    <>
      <div className={`${styles.section}`}>
        <div className='hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between'>
          <div>
            <Link to="/">
              <img src={logo} alt='logo' className='h-60 w-45' />
            </Link>
          </div>
          <div className='w-[50%] relative'>
            <input type='text' placeholder='Search...' value={searchTerm} onChange={handleSearch} className='h-[40px] w-full px-2 border-[#3982db] border-[2px] rounded-md' />
          ...
          <div className={`${styles.button} bg-[red]`}>
            <Link to='/seller'>
              <h1 className='text-[#fff] flex items-center text-[16px] font-bold'>
        ...
        <div className={`${styles.section} relative ${styles.normalFlex} justify-between`}>
          <div onClick={() => setDropDown(!dropDown)}>
            <div className='relative h-[60px] mt-[10px] w-[270px] hidden 1000px:block'>
              ...
              <button className={`h-[90%] w-full flex justify-between items-center pl-10 bg-white font-sans text-lg font-[500] select-none rounded-md`}>
                All Categories
              </button>
            ...
            <div className={`${styles.normalFlex}`}>
              <div className='relative cursor-pointer mr-[15px]'>
                <AiOutlineHeart
                  ...
                  color='white'
                />
                <span className='absolute right-0 top-0 rounded-full bg-[#4fdf5b] w-4 h-4 top rigth p-0 m-0 text-white font-mono text-[12px] leading-tight text-center'>
                  0
                </span>
              </div>
            </div>
